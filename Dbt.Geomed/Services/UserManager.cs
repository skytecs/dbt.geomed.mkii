...
namespace Dbt.Geomed.Services
{
    ...
    //        _administrationSettings = administrationSettings?.Value ?? throw new ArgumentNullException(nameof(administrationSettings));
    ...
    //        var customer = await _dataContext.Accounts.SingleOrDefaultAsync(x => x.Email == username && x.Password == hash);
    ...
    //    {
    //        if (_dataContext.Accounts.Any(x => x.Email == username))
    //        {
    ...
    //        _dataContext.Accounts.Add(customer);
    ...
    //    public async Task<Account> Register(string email, string name = null, string phone = null)
    //    {

    //        if (!String.IsNullOrWhiteSpace(email) && await _dataContext.Accounts.AnyAsync(x => x.Email == email.ToLowerInvariant().Trim()))
    //        {
    //            return null;
    //        }

    //        if (!String.IsNullOrWhiteSpace(phone) && await _dataContext.Accounts.AnyAsync(x => x.Phone == phone.ToLowerInvariant().Trim()))
    //        {
    //            return null;
    //        }
